...
<th>User</th><th>Document</th><th>Status</th>
<?php
include("db_connect.php");

$sqr="select * from user_details where doc_path!='NULL' and vf_flag2='yes' and u_type!='verifier' or 'admin'";
$res=mysql_query($sqr);
while($r=mysql_fetch_array($res))
{
	echo "<tr><td>$r[4]</td><td><a href='".$r[14]."'>Download</a></td><td>Verified User</td></tr>";
}
?></table>
</body>
</html>